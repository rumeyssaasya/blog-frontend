...
export default function MyPosts({ userId, token, theme }) {
  ...
  return (
    <ProtectedPage>
      <div className="flex flex-wrap gap-6" style={{margin:'20px'}}>
        <AnimatePresence>
          {posts.map(post => (
            <motion.div
              key={post._id}
            ...
            >
              ...
              <div className="relative self-end" style={{marginTop:'3px'}}>
                <BsThreeDots
                  size={22}
                ...
                {openMenu === post._id && (
                  ...
                  style={{marginTop:'5px'}}>
                    <p className="hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer rounded-t-md text-white"
