...
function PostCard({ post, theme, token, onDelete }) {
  ...
  return (
    <div style={{ marginBottom: "16px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px", paddingLeft: "16px", paddingRight: "16px" }}>
      ...
      <motion.div
        ...
        style={{
          ...
          display: "flex",
          position: "relative",
          alignItems: hasImage ? "flex-start" : "center", // resim yoksa dikey ortala
        }}
      ...
      >
        ...
        <div style={{
          ...
          {/* Başlık ve İçerik */}
          <div>
            <p style={{ fontSize: "20px", fontWeight: "bold", marginBottom: "8px", textAlign: hasImage ? "left" : "center" }}>{post.title}</p>
            <p style={{ color: theme === "dark" ? "lightGray" : "#18191a", textAlign: hasImage ? "left" : "center" }}>{post.content}</p>
          </div>
