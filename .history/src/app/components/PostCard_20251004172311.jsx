...
import PostDetail from "../posts/[id]/page";
...
function PostCard({ post, theme }) {
  ...
  return (
    <div className="cursor-pointer " onClick={postDetail} style={{ marginBottom: "16px", width: "500px" }}>
      {/* Üst Bilgi */}
      ...
      >
        ...
        <div style={{
          ...
          <p style={{ display:'block', color: theme === "dark" ? "lightGray" : "#18191a" }}>
