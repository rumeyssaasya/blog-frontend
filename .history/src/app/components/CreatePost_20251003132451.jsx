  ...
  return (
    <>
      ...
      {/* Modal Card */}
        ...
        style={{
            position: "fixed",      // burası sabit
            top: "10%",             // dikey ortala
            left: "30%",            // yatay ortala
            transform: "translate(-50%, -50%)",
            zIndex: 2000,           // button ve overlay üstünde
            width: "100%",
            maxWidth: "600px",
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <textarea
            ...
            style={{ padding: "12px", borderRadius: "8px", border: "1px solid #d1d5db", height: "140px", resize: "none" }}
            required
          />
          <input
            type="file"
