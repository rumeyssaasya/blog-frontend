                ...
                {isUpdating ? (
                    <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginTop: "8px" }}>
                        ...
                        <textarea
                            ...
                            style={{ padding: "4px", borderRadius: "4px" }}
                        />
                        <button onClick={handleUpdate} style={{ padding: "4px", background: "#4f46e5", color: "#fff", borderRadius: "4px" }}>
                            Kaydet
                        </button>
                    </div>
                ) : (
                    <p
                        style={{ cursor: "pointer", borderTopLeftRadius: "8px", borderTopRightRadius: "8px", padding: "8px 12px" }}
