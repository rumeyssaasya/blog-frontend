    ...
    <div className="mb-4">
      ...
      <div className="flex justify-between items-center mb-1 px-4">
        <div className="flex items-center gap-2">
          ...
          <p className="text-l mt-1">{post.author.username}</p>
        </div>
        {token && (
          <ProtectedPage>
            <div className="relative">
              ...
              {openMenu && (
                ...
                >
                  <p className="cursor-pointer rounded-t-md p-2">Güncelle</p>
                  <p className="cursor-pointer rounded-b-md p-2 text-red-600" onClick={() => handleDelete(post._id)}>Sil</p>
                </div>
              )}
            </div>
          </ProtectedPage>
      ...
      >
        ...
        <div className="flex flex-col justify-between flex-1 relative">
          {/* Başlık ve İçerik */}
          <div>
            <p className="text-xl font-bold mb-1">{post.title}</p>
