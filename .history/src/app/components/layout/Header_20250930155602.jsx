...
export function Header() {
  ...
  return (
    <header className="mt-[]">
      <div className="container mx-auto  light:bg-indigo-300 dark:bg-violet-800 ">
        ...
        <div className="flex items-center  h-20 p-10">
          ...
          <div className="font-bold ">
            <div className='light:text-violet-800 text-5xl dark:text-indigo-100'>Tarvina Blog</div>
          </div>
          {/*Right Section*/}
