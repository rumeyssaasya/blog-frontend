...
export function Header() {
  ...
  return (
    <header>
      <div className="bg-indigo-300 dark:bg-violet-700 p-4 w-full">
      ...
      <div className='flex justify-center m-4'>
        <nav className="flex items-center justify-center w-fit gap-6 bg-indigo-100 dark:bg-violet-800 p-3 text-lg font-medium text-violet-900 dark:text-white">
        {links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
