  ...
  return (
    <header>
      ...
      <div className='flex items-center justify-center gap-6'>
        <nav className="md:flex items-center justify-center gap-6 w-full bg-indigo-100 dark:bg-violet-800 p-3 text-lg font-medium text-violet-900 dark:text-white">
          {links.map((link) => (
