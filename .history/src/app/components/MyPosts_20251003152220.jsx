          ...
          {posts.map(post => (
            ...
            >
              ...
              <div className="relative mt-2 self-end">
                ...
                />
                {openMenu === post._id && (
                  <div className="absolute right-0 mt-2 w-28 rounded-md border border-gray-300 dark:border-gray-600 text-sm shadow-sm bg-white dark:bg-gray-800 z-10">
                    <p className="px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer rounded-t-md">
                      Güncelle
                    </p>
                    <p
                      onClick={() => handleDelete(post._id)}
                      className="px-3 py-2 text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer rounded-b-md"
