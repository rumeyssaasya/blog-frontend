...
import { fetchPosts, likePost } from './redux/slices/postsSlice'
          ...
          {posts.map((post) => (
            ...
            <div className='' key={post._id}>
              <div className='flex items-center gap-2 mb-2' style={{marginBottom:'5px',}}>
                ...
                <p className="text-l mt-4">{(post.author.username|| "Kullanıcı Silinmiş")}</p>
              </div>
                    ...
                    <div className="absolute bottom-3 right-3 flex flex-col justify-end items-center gap-2">
                      <motion.div whileTap={{ scale: 1.3 }} className="flex items-center gap-1">
                        <TiHeart
                          ...
                          style={{
                            color: Array.isArray(post.likedByUsers) && post.likedByUsers.includes(currentUser?._id) ? "#ff4444" : (theme === "dark" ? "#e0e0e0" : "#18191a"),
                          }}
