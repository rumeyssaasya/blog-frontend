...
export default function MyProfile() {
  ...
  useEffect(() => {
    if (authUser?._id) dispatch(getUserProfile(authUser._id));
  ...
  return (
    <ProtectedPage>
      {!userProfile ? (
        <p style={{ textAlign: "center", marginTop: "50px" }}>Profil yükleniyor veya bulunamadı...</p>
      ) : (
        <div>
          <div
            style={{
            ...
            {open && (
              <div
                ...
                style={{
                  ...
                  border: `1px solid ${theme === "dark" ? "#374151" : "#d1d1d1"}`,
                }}
              >
                {isEditOpen && (
                  <UpdateProfileForm
          ...
          {postsStatus === 'loading' ? (
            <p style={{ textAlign: "center", marginTop: "50px" }}>Gönderiler yükleniyor...</p>
          ) : posts.length === 0 ? (
            <p style={{ textAlign: "center", marginTop: "50px" }}>Henüz gönderi yok.</p>
          ) : (
