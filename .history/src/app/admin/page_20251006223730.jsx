...
export default function AdminPanel() {
  ...
  const handleCreatePost = () => {
    ...
    dispatch(createPostByAdmin(postData));
  ...
  return (
    <ProtectedAdmin>
      ...
      <div style={containerStyle}>
        ...
        {activeTab === 'users' && (
            <h2 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '16px', color: '#6D28D9' }}>Çıkış Yap</h2>
        )}
        ...
        {activeTab === 'posts' && (
          <section style={sectionStyle}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', marginBottom: '16px' }}>
              ...
              <button onClick={handleCreatePost} style={{ ...buttonStyle, backgroundColor: '#10B981' }}>Oluştur</button>
            </div>
              ...
              <div ref={postDetailRef} style={{ marginTop: '24px', padding: '16px', border: '1px solid #C4B5FD', borderRadius: '12px', backgroundColor: '#F3E8FF' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '12px' }}>
                    ...
                    })} style={{ ...buttonStyle, backgroundColor: '#3B82F6' }}>Düzenle</button>
