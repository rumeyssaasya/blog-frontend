    ...
    <div className="container mx-auto p-4">
      ...
      {status === 'succeeded' && (
        <div className=" flex flex-col items-center justify-center gap-6">
          {posts.map((post) => (
            <div className='h-50 w-120    shadow-md transition-shadow duration-300' key={post._id}>
              ...
              <div
                key={post._id}
                className="flex flex-row justify-between items-center bg-white  dark:bg-slate-800  rounded-lg p-6 hover:shadow-xl "
              >
                <div>
                  <Image
