    ...
    <div className="container mx-auto p-4">
      ...
      {status === 'succeeded' && (
        <div className=" flex flex-col items-center justify-center gap-6 min-h-screen">
          {posts.map((post) => (
            <div className='h-50 w-120 ' key={post._id}>
              ...
              <div
                key={post._id}
                className="flex flex-row justify-between items-center bg-white  dark:bg-slate-800 shadow-md rounded-lg p-6 hover:shadow-xl transition-shadow duration-300"
              >
                <div>
                  <Image
