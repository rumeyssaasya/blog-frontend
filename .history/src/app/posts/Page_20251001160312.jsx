              ...
              <div className='flex items-center gap-2 mb-2' style={{marginBottom:'5px',}}>
                ...
                {post?.image && (
                  ...
                  >
                    ...
                    <div>
                      <TiHeart size={40} className="text-red-500" />
                      <MdModeComment size={40} className="text-blue-500" />
                    </div>
                  </div>
                )}
                {!post?.image && (
                  ...
                  >
                    ...
                    <div>
                      <TiHeart size={40} className="text-red-900" />
                      <MdModeComment size={40} className="text-black-500" />
                    </div>
                  </div>  
                )}
              </div>
