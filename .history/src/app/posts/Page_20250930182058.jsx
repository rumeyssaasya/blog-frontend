...
export default function PostsPage() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {status === 'succeeded' && (
        <div className="grid grid-rows w-2xl justify-center text-center gap-6">
          {posts.map((post) => (
            <div
              key={post._id}
              className="bg-white dark:bg-slate-800 shadow-md rounded-lg p-6 hover:shadow-xl transition-shadow duration-300"
            >
              <h2 className="text-xl font-bold size-1 mb-2">{post.title}</h2>
