            ...
            <div className='' key={post._id}>
              <div className='flex items-center gap-2 mb-2' style={{marginBottom:'5px',}}>
                ...
                {post?.image && (
                  <motion.div
                    key={post._id}
                    className="relative flex flex-row justify-between h-50 w-150 rounded-lg shadow-md transition-shadow duration-300 gap-1"
                    style={{
                  ...
                  >
                    ...
                    {/* İkonlar - Sağ Alt */}
                    <div className="absolute bottom-3 right-3 flex flex-col justify-end items-center gap-3">
