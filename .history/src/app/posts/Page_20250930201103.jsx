        ...
        <div className=" flex flex-col items-center justify-center gap-6">
          {posts.map((post) => (
            <div className='' key={post._id}>
              ...
              <div
                key={post._id}
                className="flex flex-row justify-between items-center h-50 w-150 bg-white  dark:bg-slate-800  rounded-lg p-6 hover:shadow-xl shadow-md transition-shadow duration-300 "
              >
                <div>
                  <Image
