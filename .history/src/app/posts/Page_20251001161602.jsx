              ...
              <div className='flex items-center gap-2 mb-2' style={{marginBottom:'5px',}}>
                ...
                {post?.image && (
                  ...
                  >
                    ...
                    <div className='absolute bottom-3 right-3 flex flex-col justify-end items-center gap-2' style={{marginRight:'20px'}}>
                      <TiHeart size={35} className="text-red-800 cursor-pointer hover:scale-110 transition-transform" />
                      <MdModeComment size={28} className="text-black-500 cursor-pointer hover:scale-110 transition-transform" />
                    </div>
                  </div>
                )}
                {!post?.image && (
