          ...
          {posts.map((post) => (
            <div className='' key={post._id}>
              <div className='flex items-center gap-2 mb-2' style={{marginBottom:'5px',}}>
                ...
                {post?.image && (
                  <div key={post._id}
                    className="relative flex flex-row justify-between h-50 w-150  rounded-lg hover:shadow-xl shadow-md transition-shadow duration-300 gap-4"
                  ...
                  >
                    ...
                    <div className='absolute bottom-3 right-3 flex flex-col justify-center items-center gap-2' style={{marginRight:'20px'}}>
                      <TiHeart size={35} className="text-red-800" />
                      <MdModeComment size={28} className="text-black-500" />
                    </div>
                  </div>
                )}
                {!post?.image && (
