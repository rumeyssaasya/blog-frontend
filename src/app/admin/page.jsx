...
import { adminLogin, fetchAllUsers, fetchAllPosts, fetchAllComments, deleteUserByAdmin, deletePostByAdmin, deleteCommentByAdmin, createPostByAdmin, updatePostByAdmin, updateUserByAdmin } from '../redux/slices/adminSlice';
    ...
    <div style={{ padding: "20px" }}>
      ...
      {activeTab === 'posts' && (
        <section>
          ...
          {posts.map(post => (
            <div key={post._id} className="flex justify-between items-center bg-gray-100 p-2 mb-2 rounded">
